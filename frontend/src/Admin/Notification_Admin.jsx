...
const Notification_Admin = () => {
    ...
    const handleUpdateApprovalStatus = async (id, status) => {
        const response = await axios.patch(
            "http://localhost:3001/issue/approval",
            {
                id: id,
        ...
        if (response.status) {
            ...
            Swal.fire({
                icon: "success",
                title: "Berhasil",
                text: `Status approval barhasil di update menjadi ${
                                    ...
                                    (!data?.approval_status ||
                                        ...
                                        >
                                            ...
                                            <div className="flex-grow pl-4">
                                                ...
                                                <h5 className="text-blue-600 font-medium mt-2">
                                                    {data.title}
                                                </h5>
                            ...
                            volunteers?.map((volunteerData, x) => {
                                return (
                                    <div
                                        key={x}
                                        onClick={() =>
                                            handleSelectVolunteer(volunteerData)
                                        }
                                        className="flex items-start bg-white p-4 shadow-md rounded-lg mb-4 cursor-pointer"
                                    >
                                        <div className="mr-4">
